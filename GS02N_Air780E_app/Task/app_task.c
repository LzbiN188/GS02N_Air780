...
{
	int32_t lat, lon;
	lat = sysparam.lastlat * 10000000;
	lon = sysparam.lastlon * 10000000;
...
void saveHistoryGps(void)
{
	...
	sysparam.lastlat = gpsinfo->latitude;
	sysparam.lastlon = gpsinfo->longtitude;
	paramSaveAll();
	LogMessage(DEBUG_ALL, "saveHistoryGps==>OK");
}
